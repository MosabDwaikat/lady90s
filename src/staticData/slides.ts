import { SlickSliderProps } from "../components/Hero/carousel";

export const slides: SlickSliderProps["slides"] = [
  {
    img: "https://lady90s.com/cdn/shop/files/picture-3-perfumes...png?v=1712957453&width=2000",
